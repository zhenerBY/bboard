...
from .forms import ChangeUserInfoForm, RegisterUserForm, SearchForm, AIFormSet, BbForm, UserCommentForm, \
    GuestCommentForm
...
class DeleteUserView(LoginRequiredMixin, DeleteView):
    ...
    def post(self, request, *args, **kwargs):
        logout(request)
        messages.add_message(request, messages.SUCCESS, 'Поль зователь удален')
